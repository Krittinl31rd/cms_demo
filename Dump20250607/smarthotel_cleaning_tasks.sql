...
CREATE TABLE `cleaning_tasks` (
  ...
  CONSTRAINT `cleaning_tasks_ibfk_2` FOREIGN KEY (`assigned_to`) REFERENCES `users` (`id`),
  CONSTRAINT `cleaning_tasks_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`),
  CONSTRAINT `cleaning_tasks_ibfk_4` FOREIGN KEY (`status_id`) REFERENCES `task_statuses` (`id`)
