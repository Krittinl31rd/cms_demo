          ...
          {taskImages[`before_${selectedTask.id}`]?.length > 0 && (
            <div className="max-h-64 overflow-y-auto  border-1  border-gray-300 p-2 rounded-lg">
              <div className="grid grid-cols-3 gap-2">
                {taskImages[`before_${selectedTask.id}`].map((img, index) => (
        ...
        <div className="space-y-2">
          <div>
            <h1 className="font-semibold">
              Start at:{" "}
              {dayjs(selectedTask?.started_at).format("DD MMMM YYYY HH:mm:ss")}
            </h1>
            <div className="max-h-64 overflow-y-auto  border-1  border-gray-300 p-2 rounded-lg">
              <div className="grid grid-cols-3 gap-2">
          ...
          <div>
            ...
            {taskImages[`after_${selectedTask.id}`]?.length > 0 && (
              <div className="max-h-64 overflow-y-auto  border-1  border-gray-300 p-2 rounded-lg">
                <div className="grid grid-cols-3 gap-2">
                  {taskImages[`after_${selectedTask.id}`].map((img, index) => (
                    <div key={index} className="relative">
                      <img
                        src={img.url}
                        alt={`preview-${index}`}
          ...
          >
            ...
            <input
              ...
              onChange={(e) => handleImageChange(e, `after_${selectedTask.id}`)}
            />
          </label>
          <div>
...
export default UpdateDetailWork;
