...
exports.CreateDevice = async (req, res) => {
  ...
  try {
    ...
    const staticControlsMap = {
      ...
      [device_type.CONFIG]: [
        { control_id: 1, name: "SLEEP  MODE - START HOUR" },
        { control_id: 2, name: "SLEEP  MODE - START MIN" },
        { control_id: 3, name: "SLEEP  MODE - ESM DELAY" },
        { control_id: 4, name: "SLEEP  MODE - MAXIMUM TEMP" },
        { control_id: 5, name: "SLEEP  MODE - END HOUR" },
        { control_id: 6, name: "SLEEP  MODE - END MIN" },
        { control_id: 7, name: "CHECK IN  / GUEST IN - FAN SPEED" },
        { control_id: 8, name: "CHECK IN  / GUEST IN - DEFAULT TEMP" },
        { control_id: 9, name: "CHECK  OUT - FAN SPEED" },
        { control_id: 10, name: "CHECK  OUT - DEFAULT TEMP" },
        { control_id: 11, name: "GUEST  OUT - FAN SPEED" },
        { control_id: 12, name: "GUEST  OUT - DEFAULT TEMP" },
        { control_id: 13, name: "GUEST  OUT - ESM DELAY" },
        { control_id: 14, name: "CHECK IN  / GUEST IN - KEYCARD DELAY" },
        {
          control_id: 15,
        ...
        { control_id: 20, name: "DATE TIME - HOUR" },
        { control_id: 21, name: "DATE TIME - MIN" },
        { control_id: 22, name: "DATE TIME - SEC" },
        { control_id: 23, name: "DATE TIME - DATE" },
        { control_id: 24, name: "DATE TIME - MONTH" },
        { control_id: 25, name: "DATE TIME - YEAR" },
        { control_id: 26, name: "GUEST  OUT - FAN SPEED +60mins" },
        { control_id: 27, name: "GUEST  OUT - DEFAULT TEMP +60mins" },
        { control_id: 28, name: "GUEST  OUT - ESM DELAY +60mins" },
        { control_id: 29, name: "GUEST  OUT - FAN SPEED +120mins" },
        { control_id: 30, name: "GUEST  OUT - DEFAULT TEMP +120mins" },
        { control_id: 31, name: "GUEST  OUT - ESM DELAY +120mins" },
      ],
